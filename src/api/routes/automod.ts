 ...
 */
router.get('/rules', asyncHandler(async (req: Request<GuildParams>, res) => {
 ...
 */
router.get('/rules/:ruleId', asyncHandler(async (req: Request<GuildRuleParams>, res) => {
 ...
 */
router.post('/rules', asyncHandler(async (req: Request<GuildParams>, res) => {
    const { guildId } = req.params;
 ...
 */
router.patch('/rules/:ruleId', asyncHandler(async (req: Request<GuildRuleParams>, res) => {
    const { guildId, ruleId } = req.params;
 ...
 */
router.delete('/rules/:ruleId', asyncHandler(async (req: Request<GuildRuleParams>, res) => {
    const { guildId, ruleId } = req.params;
