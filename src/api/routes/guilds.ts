 ...
 */
router.get('/:guildId/channels', asyncHandler(async (req, res) => {
    const { guildId } = req.params;
 ...
 */
router.get('/:guildId/roles', asyncHandler(async (req, res) => {
    const { guildId } = req.params;
 ...
 */
router.get('/:guildId/emojis', asyncHandler(async (req, res) => {
    const { guildId } = req.params;
 ...
 */
router.get('/:guildId/bans', asyncHandler(async (req, res) => {
    const { guildId } = req.params;
 ...
 */
router.get('/:guildId/invites', asyncHandler(async (req, res) => {
    const { guildId } = req.params;
