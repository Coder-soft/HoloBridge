 ...
 */
router.get('/:eventId', asyncHandler(async (req: Request<GuildEventParams>, res) => {
 ...
 */
router.patch('/:eventId', asyncHandler(async (req: Request<GuildEventParams>, res) => {
    const { guildId, eventId } = req.params;
 ...
 */
router.delete('/:eventId', asyncHandler(async (req: Request<GuildEventParams>, res) => {
    const { guildId, eventId } = req.params;
 ...
 */
router.get('/:eventId/users', asyncHandler(async (req: Request<GuildEventParams>, res) => {
    const { guildId, eventId } = req.params;
